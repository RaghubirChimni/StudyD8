...
public class MainActivity extends AppCompatActivity {
    TextView welcomeText, unverifiedText, Profile, courseSearch, StudyBuds, messages;
    FirebaseAuth fAuth;
  ...
  //  boolean has
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            courseSearch = findViewById(0);
            messages = findViewById(R.id.MessagesScreen);
            ...
            messages.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    startActivity(new Intent(getApplicationContext(), MessagesScreen.class));
                }
            });
        }
        catch (Exception e){
